...
module sobel_mag_hls_xFSobelFilter3x3_Pipeline_Clear_Row_Loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((img_in_data63_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((img_in_data63_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (img_in_data63_empty_n == 1'b0);
end
...
assign buf_V_1_d1 = img_in_data63_dout;
...
endmodule //sobel_mag_hls_xFSobelFilter3x3_Pipeline_Clear_Row_Loop
